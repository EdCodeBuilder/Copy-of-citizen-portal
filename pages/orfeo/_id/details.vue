    ...
    timelines: [
      {
        ...
        icon: 'mdi-briefcase',
        text:
          'Wifey made the best Fathers Day meal ever. So thankful so happy so blessed. Thank you for making my family We just had fun with the “future” theme !!! It was a fun night all together ... The always rude Kanye Show at 2am Sold Out Famous viewing @ Figueroa and 12th in downtown.',
      ...
      },
      {
        ...
        text:
          'Called I Miss the Old Kanye That’s all it was Kanye And I love you like Kanye loves Kanye Famous viewing @ Figueroa and 12th in downtown LA 11:10PM. What if Kanye made a song about Kanye Royère doesnt make a Polar bear bed but the Polar bear couch is my favorite piece of furniture we own It wasnt any Kanyes Set on his goals Kanye',
        action: 'info',
      ...
      },
      {
        ...
        text:
          'Tune into Big Boys 92.3 Im about to play the first single from Cruel Winter also to Kim’s hair and makeup Lorraine jewelry and the whole style squad at Balmain and the Yeezy team. Thank you Anna for the invite thank you to the whole Vogue team',
      },
    ],
  }),
}
