    ...
    <v-dialog v-if="userIsA('contractors-portal-hiring')" v-model="dialog">
      <validation-observer ref="contract_form" v-slot:="{ handleSubmit }">
        <v-form @submit.prevent="handleSubmit(onSubmit)">
          <v-card>
            <v-card-title>Agregar Contrato</v-card-title>
            <v-card-text>
              <v-row>
                <!-- Contract Type -->
            ...
            <v-card-actions>
              ...
              <v-btn
                ...
                type="submit"
              >
                <v-icon left dark>mdi-send</v-icon> Agregar Contrato
              </v-btn>
            </v-card-actions>
          </v-card>
        </v-form>
          ...
          <v-card>
            ...
            <v-card-actions>
              ...
              <v-btn
                ...
                type="submit"
              >
                <v-icon left dark>mdi-send</v-icon> Modificar Contrato
              </v-btn>
            </v-card-actions>
          </v-card>
        </v-form>
          ...
          <v-card>
            ...
            <v-card-actions>
              ...
              <v-btn
                ...
                type="submit"
              >
                <v-icon left dark>mdi-send</v-icon> Modificar Contratista
              </v-btn>
            </v-card-actions>
          </v-card>
        </v-form>
...
export default {
  ...
  methods: {
    ...
    onSelectUpdate(item) {
      const open = () => {
        this.contract = new Contract(this.$route.params.id, item)
